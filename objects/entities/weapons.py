...
from objects.entities.bullets import Bullet, Grenade, BlowingBullet
    ...
    def get_bullet(self):
        ...
        for i in range(5):
            bullet_pos = (
                ...
                + Vec2((random.random() - 0.5) * 10, (random.random() - 0.5) * 10)
            )
            bullet = Bullet(
                bullet_pos.x,
                bullet_pos.y,
        ...
        #     10,
        #     30,
        #     sprite_path="assets/bullets/bullet.png",
        # )
        # bullet.velocity = self.direction * 50
        # bullets.append(bullet)
        #
        ...
        #     sprite_path="assets/bullets/bullet.png",
        # )
        # bullet.velocity = self.direction.rotate(math.pi / 9) * 50
        # bullets.append(bullet)
        return bullets
...
class Rocket(Weapon):
    ...
    def get_bullet(self):
        ...
        bullet = BlowingBullet(
            ...
            25,
            150,
            sprite_path=join(ROOT, "assets", "bullets", "rocket.png"),
        )
...
class Egg(Weapon):
    def get_bullet(self):
        ...
        bullet = Grenade(
            ...
            50,
            300,
            sprite_path=join(ROOT, "assets", "bullets", "egg.png"),
        )
        bullet.velocity = Vec2(3 * (random.randint(0, 1) - 0.5) * 2, 0)
        bullets.append(bullet)
        return bullets
